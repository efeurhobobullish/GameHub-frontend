    ...
    <div className="min-h-screen w-full bg-background flex items-center justify-center relative overflow-hidden font-sans selection:bg-primary/20">
      ...
      <div className="relative z-10 p-8 md:p-12 max-w-lg w-full text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <Link 
            href="/"
            className="btn btn-primary h-12 px-8 rounded-full shadow-lg shadow-primary/25 hover:shadow-primary/40 hover:-translate-y-1 transition-all"
          >
            <Home size={18} />
        ...
        <div className="mt-12 pt-8 border-t border-line/30">
            <Link href="/help" className="text-sm text-muted hover:text-primary transition-colors inline-flex items-center gap-2">
                <Search size={14} />
